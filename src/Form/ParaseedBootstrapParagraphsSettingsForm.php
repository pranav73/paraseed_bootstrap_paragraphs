...
namespace Drupal\Paraseed_bootstrap_paragraphs\Form;
 ...
 */
class ParaseedBootstrapParagraphsSettingsForm extends ConfigFormBase {

  /**
   * Get the from ID.
   */
  public function getFormId() {
    return 'Paraseed_bootstrap_paragraphs_settings';
  }
  ...
  protected function getEditableConfigNames() {
    return ['Paraseed_bootstrap_paragraphs.settings'];
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $config = $this->config('Paraseed_bootstrap_paragraphs.settings');
    $form['settings']['background_colors'] = [
      '#type' => 'textarea',
      '#default_value' => $config->get('background_colors'),
      '#title' => $this->t('Available CSS styles (classes) for Paraseed Bootstrap Paragraphs'),
      '#description' => $this->t('
<p>The list of CSS classes available as background styles for Paraseed Bootstrap Pargaraphs. Enter one value per line, in the format <b>key|label</b> where <em>key</em> is the CSS class name (without the .), and <em>label</em> is the human readable name of the style in administration forms.</p><p>These styles are defined and can be customized in <code>vbp-colors</code> library that is defined in <code>Paraseed_bootstrap_paragraphs/Paraseed_bootstrap_paragraphs.libraries.yml</code>.</p><p>To customize the styles to fit your brand with your own theme, do the following:
  <ol>
    <li>Copy the SCSS (<code>Paraseed_bootstrap_paragraphs/scss/theme/vbp-colors.theme.scss</code>) and CSS (<code>Paraseed_bootstrap_paragraphs/css/theme/vbp-colors.theme.css</code>) files to your own theme.</li>
